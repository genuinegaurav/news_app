...
class BusinessScreen extends StatefulWidget {
  ...
  BusinessScreen({required this.isDarkMode});
...
class _BusinessScreenState extends State<BusinessScreen>
  ...
  Future<void> fetchMoreBusinessNews() async {
    setState(() {
      isLoadingMore = true;
    });
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://news.google.com/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNRGx6TVdZU0JXVnVMVWRDR2dKSlRpZ0FQAQ?hl=en-IN&gl=IN&ceid=IN%3Aen&page=$currentPage'));
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load more business news');
      }
    } catch (e) {
      setState(() {
        isLoadingMore = false;
