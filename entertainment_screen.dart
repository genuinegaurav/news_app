...
class EntertainmentScreen extends StatefulWidget {
  ...
  EntertainmentScreen({required this.isDarkMode});
...
class _EntertainmentScreenState extends State<EntertainmentScreen>
  ...
  Future<void> fetchMoreEntertainmentNews() async {
    setState(() {
      isLoadingMore = true;
    });
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://news.google.com/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNREpxYW5RU0JXVnVMVWRDR2dKSlRpZ0FQAQ?hl=en-IN&gl=IN&ceid=IN%3Aen&page=$currentPage'));
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load more entertainment news');
      }
    } catch (e) {
      setState(() {
        isLoadingMore = false;
    ...
    return Scaffold(
      ...
      body: BackgroundWidget(
        ...
        child: isLoading
            ...
            : RefreshIndicator(
                onRefresh: fetchEntertainmentNews,
                child: Padding(
