...
class TechnologyScreen extends StatefulWidget {
  ...
  TechnologyScreen({required this.isDarkMode});
...
class _TechnologyScreenState extends State<TechnologyScreen>
  ...
  Future<void> fetchMoreTechnologyNews() async {
    setState(() {
      isLoadingMore = true;
    });
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://news.google.com/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNRGRqTVhZU0JXVnVMVWRDR2dKSlRpZ0FQAQ?hl=en-IN&gl=IN&ceid=IN%3Aen&page=$currentPage'));
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load more technology news');
      }
    } catch (e) {
      setState(() {
        isLoadingMore = false;
