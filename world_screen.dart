...
class WorldScreen extends StatefulWidget {
  ...
  WorldScreen({required this.isDarkMode});
...
class _WorldScreenState extends State<WorldScreen>
  ...
  Future<void> fetchMoreWorldNews() async {
    setState(() {
      isLoadingMore = true;
    });
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://news.google.com/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNRGx1YlY4U0JXVnVMVWRDR2dKSlRpZ0FQAQ?hl=en-IN&gl=IN&ceid=IN%3Aen&page=$currentPage'));
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load more world news');
      }
    } catch (e) {
      setState(() {
        isLoadingMore = false;
